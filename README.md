...
Запускались тестовые файлы ```test_A.txt``` и ```test_b.txt```, размер матрицы 10000 на 10000. В гитхаб не удалось подгрузить тестовый файл в связи с большим объемом.
